  ...
  return (
      <section className="pedalBar" data-from-first="intro/">
        <div className="command left">
          ...
          <div className="command__space" data-from-first="response" data-from-last="close">CREDITS</div>
        </div>
        ...
        <div className="command right">
          ...
          <div className="command__space" data-from-first="response" data-from-last="close">GIOCA ANCORA</div>
        </div>
      </section>
  );
}